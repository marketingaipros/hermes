# Hermes Nightly State — 2026-05-31 08:00 UTC
...
Python: 3.11.15
OpenAI SDK: 2.24.0
Update available: 1928 commits behind — run 'hermes update'
...
Mem:            11Gi       2.6Gi       8.1Gi        25Mi       1.0Gi       9.1Gi
```
...
└─────────────────────────────────────────────────────────────────────────┘
  ...
  da88db09c058 [active]
    ...
    Schedule:  0 8 * * *
    Repeat:    ∞
    Next run:  2026-06-01T08:00:00+00:00
    Deliver:   local
    Script:    nightly-sync.sh
    Mode:      no-agent (script stdout delivered directly)
    Last run:  2026-05-30T08:00:55.688457+00:00  ok

  77e7ff41d6d7 [active]
    Name:      Daily Briefing Report
    Schedule:  0 12 * * *
    Repeat:    ∞
    Next run:  2026-05-31T12:00:00+00:00
    Deliver:   telegram:922739544
    Script:    daily-report.sh
    Last run:  2026-05-30T12:07:40.522952+00:00  ok

  e441804c0f18 [active]
    Name:      Wiki Daily Regeneration
    Schedule:  0 6 * * *
    Repeat:    ∞
    Next run:  2026-06-01T06:00:00+00:00
    Deliver:   local
    Last run:  2026-05-31T06:01:04.460312+00:00  ok

  c1df09012b9c [active]
    Name:      Wiki Server Watchdog
    Schedule:  */5 * * * *
    Repeat:    ∞
    Next run:  2026-05-31T08:05:00+00:00
    Deliver:   local
    Script:    wiki-watchdog.sh
    Mode:      no-agent (script stdout delivered directly)
    Last run:  2026-05-31T08:00:10.938827+00:00  ok
