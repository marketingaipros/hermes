# Hermes Nightly State — 2026-06-17 13:00 UTC

## Version
Hermes Agent v0.16.0 (2026.6.5) · upstream 24832009
Project: /usr/local/lib/hermes-agent
Python: 3.11.15
OpenAI SDK: 2.24.0
Update available: 356 commits behind — run 'hermes update'
...
Mem:            11Gi       2.3Gi       8.5Gi        30Mi       981Mi       9.4Gi
```
...
└─────────────────────────────────────────────────────────────────────────┘
  ...
  da88db09c058 [active]
    ...
    Schedule:  0 8 * * *
    Repeat:    ∞
    Next run:  2026-06-18T08:00:00-05:00
    Deliver:   local
    Script:    nightly-sync.sh
    Mode:      no-agent (script stdout delivered directly)
    Last run:  2026-06-16T08:00:45.292662-05:00  ok

  77e7ff41d6d7 [active]
    Name:      Daily Briefing Report
    Schedule:  0 12 * * *
    Repeat:    ∞
    Next run:  2026-06-17T12:00:00-05:00
    Deliver:   telegram:922739544
    Script:    daily-report.sh
    Last run:  2026-06-16T12:02:32.253320-05:00  ok

  e441804c0f18 [active]
    Name:      Wiki Daily Regeneration
    Schedule:  0 6 * * *
    Repeat:    ∞
    Next run:  2026-06-18T06:00:00-05:00
    Deliver:   local
    Last run:  2026-06-17T06:02:01.944491-05:00  ok

  c1df09012b9c [active]
    Name:      Wiki Server Watchdog
    Schedule:  */5 * * * *
    Repeat:    ∞
    Next run:  2026-06-17T08:05:00-05:00
    Deliver:   local
    Script:    wiki-watchdog.sh
    Mode:      no-agent (script stdout delivered directly)
    Last run:  2026-06-17T08:00:53.901939-05:00  ok
